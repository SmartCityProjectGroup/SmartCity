...
|**Service** | **Key** | **Payload** | 
| :------ | :------ | :----- | 
| Bürgerbüro | private.integration | {<br>"event_id": 9000,<br>"event_name":"Register New Refugee",<br>"service_name": "integration",<br>"refugee": {<br>&emsp;"firstname": "John",<br>&emsp;"lastname": "Doe",<br>&emsp;"date of birth": "12.08.2000",<br>&emsp;"email": "john@doe.com",<br>&emsp;}<br> } |
